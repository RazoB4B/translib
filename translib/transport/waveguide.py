...
def TransMatOneSlabTE(ws, la, lb, tha, m=0, a=1, n=0, b=1, RetA=True, wnorm=True, epsa=None, epsb=None, mua=None, mub=None):
    ...
    if RetA true: the wave finishing its propagation in the medium A
    if RetA false: the wave finishing its propagation in the medium B
    if wnorm true: the angular frequencies are weighted by the speed of light. The dimentions
                   a and b should correspond with the ones of c.
    if wnorm false: the wavevector is computed using the speed of light in m/s.
...
def TransMatOneSlabTM(ws, la, lb, tha, m=0, a=1, n=0, b=1, RetA=True, wnorm=True, epsa=None, epsb=None, mua=None, mub=None):
    """
